...
const Footer = () => {
  ...
  return (
    <div>
      <footer className="footer bg-base-200 text-base-content p-10" data-theme="bumbleebee">
        <nav>
          <h6 className="footer-title font-bold">Contact & Inquiry</h6>
          <p className='font-semibold'>jln.gunung agung, Br.gitgit, bakbakan, Gianyar.</p>
        ...
        <nav>
          <h6 className="footer-title font-bold">Sitemaps</h6>
          <Link to={"/"} className="link link-hover font-semibold">Homepage</Link>
          <Link to={"/tourinfo"} className="link link-hover font-semibold">Tour Info & Price</Link>
          <Link to={"/contact"} className="link link-hover font-semibold">Contact</Link>
        </nav>
        <nav>
          <h6 className="footer-title font-bold">Office Location</h6>
          <iframe
      ...
      <footer className="footer bg-base-200 text-base-content border-base-300 border-t px-10 py-4" data-theme="bumbleebee">
